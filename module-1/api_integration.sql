...
CREATE OR REPLACE SECRET course_repo.public.github_pat
  TYPE = password
  USERNAME = 'rustyvik'
  PASSWORD = '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';

-- Create the API integration
CREATE OR REPLACE API INTEGRATION git_api_integration
  API_PROVIDER = git_https_api
  API_ALLOWED_PREFIXES = ('https://github.com/RustyVik') -- URL to your GitHub profile
...
CREATE OR REPLACE GIT REPOSITORY course_repo.public.advanced_data_engineering_snowflake
  ...
  ORIGIN = 'https://github.com/RustyVik/advanced-data-engineering-snowflake.git' -- Insert URL of forked repo
